...
class _AddInformationState extends State<AddInformation> {
  ...
  final TextEditingController titleController =
      new TextEditingController(); //controller //controller
  ...
  addInformation(BuildContext context) async {
    await collectionReference.document(titleController.text).setData({
      'title': titleController.text,
      'description': descriptionController.text,
    });
    Navigator.pop(context);
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Information added successfully!"), backgroundColor: Colors.greenAccent));
  }
  @override
